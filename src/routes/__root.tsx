...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EuroVirtuals Backoffice" },
      {
        name: "description",
        content:
          "Backoffice control room for the EuroVirtuals betting platform: analytics, bets, players, promotions and governance.",
      },
      { property: "og:title", content: "EuroVirtuals Backoffice" },
      {
        property: "og:description",
        content: "Analytics, bets, players, promotions and governance for EuroVirtuals operators.",
      },
...
function RootComponent() {
  ...
  // Prefetch common reference lists on app launch so dropdowns use cached data
